...
class AmazonpageSpiderMiddleware:
...
class AmazonpageDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class PyppeteerMiddleware(object):
    ...
    async def _process_request(self, request, spider):
        browser = await launch(headless=False, args=['--disable-infobars', f'--window-size=1600,900'])  # 隐藏提示栏
        page = await browser.newPage()
        # await page.setCookie({'name':'lc-main','value':'en-US','domain':'amazon.com'})
